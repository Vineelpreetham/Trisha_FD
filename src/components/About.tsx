    ...
    <main className="w-full relative min-h-screen text-[#1A1A1A] overflow-hidden" style={{ background: "linear-gradient(to bottom, #FFFFFF 0%, #F5ECEC 30%, #E8C4C4 65%, #C98484 100%)" }}>
      ...
      <nav className="w-full pt-10 pb-4 px-6 md:px-16 lg:px-24 flex justify-between items-center z-30 relative">
        <div className="flex items-center gap-6 md:gap-10">
          ...
          <img src="https://res.cloudinary.com/dbeh0eisn/image/upload/e_background_removal,f_auto,q_auto,w_1600/v1777072569/trisha_vanam_brand_identity_cemr1y.png" alt="Trisha Vanam" style={{ height: "clamp(3.5rem, 6vw, 5rem)", width: "auto", objectFit: "contain" }} className="hidden md:block" />
        </div>
