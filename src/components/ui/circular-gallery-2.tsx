...
interface CircularGalleryProps
  ...
  bend?: number;
  /** The border radius for the images, as a percentage (0.0 to 0.5). @default 0.05 */
  borderRadius?: number;
  ...
  /** Direction of the auto-scroll. @default "left" */
  ...
  createShader() {
    ...
    this.program = new Program(this.gl, {
      ...
      fragment: `
        ...
        void main() {
          // CONTAIN mode — shows full image, no cropping (key change: min() not max())
          vec2 ratio = vec2(
          ...
          // Hide pixels outside the image bounds (letterbox transparent)
